...
public class DefaultContentDataValues implements ContentDataValues {
	...
	private static final String[] businessTypes = { "Furnishings", "Bakery",
	...
	private static final String[] emailHosts = { "gma1l", "hotma1l", "yah00",
			"somema1l", "everyma1l", "ma1lbox", "b1zmail", "ma1l2u" };

	private static final String[] tlds = { "org", "net", "com", "biz", "us", "co.uk" };
